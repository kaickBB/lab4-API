...
const db = new sqlite3.Database('./universidade.db', (erro) => {
    ...
    if (erro) {
        ...
        console.log(
            "Conectado ao banco de dados SQLite com sucesso!"
        );
    }
});
...
// Esta rota simula um banco de dados sob estresse.
    ...
    setTimeout(() => {
        ...
        if (chanceDeFalha <= 3) {
            ...
            return response.status(503).json({
                erro:
                    "Cascading Failure: O pool de conexões do Banco de Dados esgotou."
            });
        }
...
// === ROTA DE ESTATÍSTICAS PARA OS GRÁFICOS ===
